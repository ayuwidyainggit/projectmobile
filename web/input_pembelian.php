                ...
                <li>
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="daftar_suplier.php">Daftar Suplier</a></li>
                    </ul>
                </li>
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal bucket-form" action="pembelian_i_res.php" method="post">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Tgl Pembelian</label>
                        <div class="col-sm-6">
                            <input type="date" class="form-control" name="tgl_pembelian" required>
                        </div>
                    </div>
                   <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3" for="inputSuccess">Pemasok</label>
                        <div class="col-lg-6">
                     ...
                     <div class="form-group">
                        <label class="col-sm-3 control-label col-lg-3" for="inputSuccess">Jenis Pembelian</label>
                        <div class="col-lg-6">
                            <select class="form-control input-lg m-bot15" name="jenis_pembelian">
                                <option>Gelas</option>
